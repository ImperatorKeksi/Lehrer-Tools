...
class ResponsiveController {
    ...
    setupHamburgerMenu() {
        ...
        headers.forEach(header => {
            // Prüfen ob schon vorhanden (entweder durch das Skript oder manuell im HTML)
            // Wir prüfen auf verschiedene Klassen und die ID des manuellen Menüs
            if (header.hasAttribute('data-responsive-init')) return;

            const existingToggle = header.querySelector([
                '.mobile-menu-toggle',
                '.nav-toggle',
                '.mobile-nav-toggle',
                '.menu-toggle',
            ...
            if (existingToggle) {
                console.log('ResponsiveController: Manuelles Menü oder bereits initialisiertes Menü gefunden, überspringe Generierung.');
                header.setAttribute('data-responsive-init', 'true');
                return;
            }
